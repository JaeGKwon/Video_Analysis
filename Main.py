...
if missing_dependencies:
    st.error(f"❌ Missing required libraries: {', '.join(missing_dependencies)}. Please install them using pip.")
...
if not missing_dependencies and os.path.exists(ffmpeg_path):
